...
public class XClassConverter
{
    ...
    public Class<PersistableObject> convert(final BaseClass xwikiClass)
    {
        final String className =
            JavaClassNameDocumentReferenceSerializer.serializeRef(xwikiClass.getDocumentReference(),
                                                                  null);
        try {
            return (Class<PersistableObject>) this.loader.asNativeLoader().loadClass(className);
        ...
        return (Class<PersistableObject>) pc.getNativeClass();
    }
