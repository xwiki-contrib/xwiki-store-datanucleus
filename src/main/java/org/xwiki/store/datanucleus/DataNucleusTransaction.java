 ...
 * @since 3.2M1
 */
public class DataNucleusTransaction extends StartableTransactionRunnable<PersistenceManager>
{
    ...
    public DataNucleusTransaction(final PersistenceManager manager,
    ...
    public PersistenceManager getProvidedContext()
    {
        return this.manager;
    }
